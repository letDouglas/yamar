package com.yamar.inventoryservice.config;
...
public class OpenAPIConfig {
    ...
    private Info apiInfo() {
        return new Info()
                ...
                .description("RESTful microservice to manage inventory in the catalog")
                .version("1.0.0")
                .license(new License()
    ...
    private ExternalDocumentation externalDocs() {
        return new ExternalDocumentation()
                ...
                .url("https://xmor.com/docs/inventory-service");
    }
    ...
    private List<Server> apiServers(ServletContext servletContext) {
        ...
        String prodUrl = "https://xmor.com/inventory-service";
